...
<body>
    ...
    <center>
        ...
        <table width='625'>
            <tr>
                <td>
                    <font size="3" style="text-align: justify;">Yang bertanda tangan dibawah ini menerangkan bahwa pada <!--TANGGAL-->, telah melapor melalui
        ...
        <table width='625'>
            ...
            <tr>
                ...
                <td class="fs-6" width='500'>: <?php echo $data_masyarakat['tmpt_kejadian']; ?></td>
            </tr>
        </table>
        <br>
            ...
            <tr class="d-flex justify-content-between">
                <td>
                    <table width='300'>
                        ...
                        <tr>
                            <td class="d-flex justify-content-center fs-6">NAMA PELAPOR</td>
                        </tr>
                    </table>
                </td>
                <td>
