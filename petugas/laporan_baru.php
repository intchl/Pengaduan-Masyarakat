  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
          ...
          <a href="laporan_baru.php" class="list-group-item list-group-item-action bg-transparent second-text active " data-aos="fade-right">
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light py-3 px-4 shadow d-flex justify-content-between" style="background-color: maroon;">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-2 m-0 text-white" data-aos="fade-down" >Laporan Baru</h2>
        </div>
      </nav>
      ...
      <div class="container-fluid px-4 d-none d-sm-block" data-aos="zoom-in-up">
        <div class="row mt-4 ">
          <div class="col-6 d-flex justify-content-start">
            <h3 class="text-center text-uppercase fw-bold"  >Laporan Baru</h3>
          </div>
          <div class="col-6 d-flex justify-content-end">
            <form class="d-flex justify-content-end align-items-end">
              <input class="form-control me-1" type="search" placeholder="Masukkan NIK" aria-label="Search" id="search-input">
          ...
          <table class="table table-bordered shadow-sm text-center" >
            ...
            <?php
                ...
                <tr>
                  ...
                  <td>
                  <a href="tanggapi.php?id=<?php echo $c['id_pengaduan']; ?>" class="btn btn-outline-success">Tanggapi</a>
                  </td>
                </tr>
                <?php
                }
