                    ...
                    <tr>
                      ...
                      <td><?php
                        if($c['id_petugas'] >=1){
                            ?>
                            <div class="btn-group">
                                <a href="petugas-edit.php?id=<?php echo $c['id_petugas']; ?>" class="btn btn-outline-success">
                                <i class="fa-solid fa-pen-to-square"></i></a>
                            </div>

                            <div class="btn-group">
                                <a href="petugas-hapus.php?id=<?php echo $c['id_petugas']; ?>" class="btn btn-outline-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">
