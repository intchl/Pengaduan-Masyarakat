    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text fw-semibold border-bottom"
                    data-aos="fade-right">
                    <i class="fas fa-gauge me-2"></i>Dashboard</a>

                <div class="fw-bold text-uppercase ps-4 pt-2 text-secondary" style="font-size: smaller"
                    data-aos="fade-right">Fiture</div>

                <a href="laporan.php" class="list-group-item list-group-item-action bg-transparent second-text fw-semibold"
                    data-aos="fade-right">
                    <i class="fas fa-table-list me-2" href="laporan.php"></i>Laporan Masyarakat</a>

                <a href="terverifikasi.php" class="list-group-item list-group-item-action bg-transparent second-text fw-semibold"
                    data-aos="fade-right">
                    <i class="fas fa-check-double me-2"></i>Laporan Selesai</a>

                <a href="tanggapan.php" class="list-group-item list-group-item-action bg-transparent second-text fw-semibold"
                    data-aos="fade-right">
                    <i class="fas fa-pen-to-square me-2"></i>Tanggapan</a>

                <a href="petugas.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active "
                    data-aos="fade-right">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-4 shadow d-flex justify-content-between"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 text-white" data-aos="fade-down">Daftar Petugas</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid px-4 d-none d-sm-block" data-aos="zoom-in-up">
                <div class="row mt-4 ">
                    <div class="col-6 d-flex justify-content-start">
                        <h3 class="text-center text-uppercase fw-bold">Daftar Petugas</h3>
                    </div>
            ...
            <div class="container-fluid px-4 d-none d-sm-block" data-aos="zoom-in-up">
                <div class="row mt-3 mb-3">
                    <div class="col-12  d-flex justify-content-end">
                        <a href="petugas-tambah.php" class="btn btn-outline-danger">
                            ...
                            <tbody id="table-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                                <div class="btn-group">
                                                    <a href="petugas-edit.php?id=<?php echo $c['id_petugas']; ?>"
                                                        class="btn btn-outline-success">
                                                        <i class="fa-solid fa-pen-to-square"></i></a>
                                                </div>

                                                <div class="btn-group">
                                                    <a href="petugas-hapus.php?id=<?php echo $c['id_petugas']; ?>"
