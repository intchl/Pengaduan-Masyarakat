      ...
      <div class="bg-white" id="sidebar-wrapper">
        ...
        <i class="fa-solid fa-user-tie fa-xl" style="color: #610000"></i> Dashmin</div>
          ...
          <a href="laporan.php" class="list-group-item list-group-item-action bg-transparent second-text fw-semibold" data-aos="fade-right">
            <i class="fas fa-table-list me-2" ></i>Laporan Masyarakat</a>

          <a href="terverifikasi.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active " data-aos="fade-right">
      ...
      <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light py-3 px-4 shadow d-flex justify-content-between" style="background-color: maroon;">
          <div class="d-flex align-items-center">
            ...
            <h2 class="fs-2 m-0 text-white" data-aos="fade-down">Laporan Selesai</h2>
          </div>
        </nav>
        ...
        <div class="container-fluid px-4 d-none d-sm-block" data-aos="zoom-in-up">
          <div class="row mt-4 ">
            <div class="col-6 d-flex justify-content-start">
              <h3 class="text-center text-uppercase fw-bold"  >Daftar Laporan Selesai</h3>
            </div>
